...
components_types_with_names = {
    ...
    "DEV07T": ["", "dev07t_link", "", "", ""],
    "DEV09": ["", "dev09_link", "", "", ""],
    "LDR01": ["slamtec_rplidar_s1", "laser", "laser", "lidar", "rplidar"],
    "LDR06": ["slamtec_rplidar_s3", "laser", "laser", "lidar", "rplidar"],
    "LDR10": ["ouster_os0_32", "os_lidar", "os_lidar", "lidar", "ouster"],
    "LDR11": ["ouster_os0_64", "os_lidar", "os_lidar", "lidar", "ouster"],
    "LDR12": ["ouster_os0_128", "os_lidar", "os_lidar", "lidar", "ouster"],
    "LDR13": ["ouster_os1_32", "os_lidar", "os_lidar", "lidar", "ouster"],
    "LDR14": ["ouster_os1_64", "os_lidar", "os_lidar", "lidar", "ouster"],
    "LDR15": ["ouster_os1_128", "os_lidar", "os_lidar", "lidar", "ouster"],
